...
public class TestRequest  implements java.io.Serializable {
    ...
    /**
     * Gets the credentials value for this TestRequest.
     * 
     * @return credentials
     */
    ...
    /**
     * Sets the credentials value for this TestRequest.
     * 
     * @param credentials
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://api.frenoy.net/TabTAPI", ">TestRequest"));
