...
public class ResultType implements java.io.Serializable {
    ...
    public static final ResultType V = new ResultType(_V);
    public static final ResultType D = new ResultType(_D);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://api.frenoy.net/TabTAPI", "ResultType"));
    }
    /**
